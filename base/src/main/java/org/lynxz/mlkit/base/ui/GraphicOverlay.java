...
package org.lynxz.mlkit.base.ui;
...
import org.lynxz.mlkit.base.util.FakeGuavaUtil;
...
public class GraphicOverlay extends View {
    ...
    public abstract static class Graphic {
        ...
        public void updatePaintColorByZValue(
            ...
            if (zInScreenPixel < 0) {
                ...
                v = FakeGuavaUtil.constrainToRange(v, 0, 255);
    ...
    public void setImageSourceInfo(int imageWidth, int imageHeight, boolean isFlipped) {
        FakeGuavaUtil.checkState(imageWidth > 0, "image width must be positive");
        FakeGuavaUtil.checkState(imageHeight > 0, "image height must be positive");
        synchronized (lock) {
