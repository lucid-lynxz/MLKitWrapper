...
public class TextGraphic extends GraphicOverlay.Graphic {
    ...
    public void draw(Canvas canvas) {
        LogWrapper.d(TAG, "Text is: " + text.getText());
        for (TextBlock textBlock : text.getTextBlocks()) {
            // Renders the text at the bottom of the box.
            LogWrapper.d(TAG, "TextBlock text is: " + textBlock.getText());
            LogWrapper.d(TAG, "TextBlock boundingbox is: " + textBlock.getBoundingBox());
            LogWrapper.d(TAG, "TextBlock cornerpoint is: " + Arrays.toString(textBlock.getCornerPoints()));
            if (shouldGroupTextInBlocks) {
                ...
                for (Line line : textBlock.getLines()) {
                    LogWrapper.d(TAG, "Line text is: " + line.getText());
                    LogWrapper.d(TAG, "Line boundingbox is: " + line.getBoundingBox());
                    LogWrapper.d(TAG, "Line cornerpoint is: " + Arrays.toString(line.getCornerPoints()));
                    LogWrapper.d(TAG, "Line confidence is: " + line.getConfidence());
                    LogWrapper.d(TAG, "Line angle is: " + line.getAngle());
                    String text =
                            showLanguageTag
                                    ? String.format(
                    ...
                    for (Element element : line.getElements()) {
                        LogWrapper.d(TAG, "Element text is: " + element.getText());
                        LogWrapper.d(TAG, "Element boundingbox is: " + element.getBoundingBox());
                        LogWrapper.d(TAG, "Element cornerpoint is: " + Arrays.toString(element.getCornerPoints()));
                        LogWrapper.d(TAG, "Element language is: " + element.getRecognizedLanguage());
                        LogWrapper.d(TAG, "Element confidence is: " + element.getConfidence());
                        LogWrapper.d(TAG, "Element angle is: " + element.getAngle());
                        for (Symbol symbol : element.getSymbols()) {
                            LogWrapper.d(TAG, "Symbol text is: " + symbol.getText());
                            LogWrapper.d(TAG, "Symbol boundingbox is: " + symbol.getBoundingBox());
                            LogWrapper.d(TAG, "Symbol cornerpoint is: " + Arrays.toString(symbol.getCornerPoints()));
                            LogWrapper.d(TAG, "Symbol confidence is: " + symbol.getConfidence());
                            LogWrapper.d(TAG, "Symbol angle is: " + symbol.getAngle());
                        }
                    }
                }
            }
